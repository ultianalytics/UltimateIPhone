...
/*
 * This is a slightly patched version of ASIHTTPRequest 1.8.1
 *
 * Modifications made are:
 * 1) The default timeout has been changed from 10 seconds to 30 seconds
 * 2) By default all requests are allowed to run in the background.
 *
 */
...
// Global Debug flag, used to change behavior in debug contexts - PJB 9/6/11
extern BOOL ASIDebug;
